...
public abstract class AuthzDecisionStatementType extends oasis.names.tc.SAML.v2_0.assertion.StatementAbstractType 
implements java.io.Serializable
{
     ...
     * Field _decision.
     */
    private oasis.names.tc.SAML.v2_0.assertion.types.DecisionType _decision;
    ...
    public boolean equals(
        ...
        if (obj instanceof AuthzDecisionStatementType) {

            AuthzDecisionStatementType temp = (AuthzDecisionStatementType)obj;
            boolean thcycle;
            boolean tmcycle;
            ...
            if (this._decision != null) {
                if (temp._decision == null) return false;
                if (this._decision != temp._decision) {
                    thcycle=org.castor.core.util.CycleBreaker.startingToCycle(this._decision);
                    tmcycle=org.castor.core.util.CycleBreaker.startingToCycle(temp._decision);
                    if (thcycle!=tmcycle) {
                        if (!thcycle) { org.castor.core.util.CycleBreaker.releaseCycleHandle(this._decision); };
                        if (!tmcycle) { org.castor.core.util.CycleBreaker.releaseCycleHandle(temp._decision); };
                        return false;
                    }
                    if (!thcycle) {
                        if (!this._decision.equals(temp._decision)) {
                            org.castor.core.util.CycleBreaker.releaseCycleHandle(this._decision);
                            org.castor.core.util.CycleBreaker.releaseCycleHandle(temp._decision);
                            return false;
                        }
                        org.castor.core.util.CycleBreaker.releaseCycleHandle(this._decision);
                        org.castor.core.util.CycleBreaker.releaseCycleHandle(temp._decision);
     ...
     */
    public oasis.names.tc.SAML.v2_0.assertion.types.DecisionType getDecision(
    ) {
    ...
    public int hashCode(
        ...
        if (_decision != null
               && !org.castor.core.util.CycleBreaker.startingToCycle(_decision)) {
           result = 37 * result + _decision.hashCode();
           org.castor.core.util.CycleBreaker.releaseCycleHandle(_decision);
        }
        if (_actionList != null
    ...
    public void setDecision(
            final oasis.names.tc.SAML.v2_0.assertion.types.DecisionType decision) {
