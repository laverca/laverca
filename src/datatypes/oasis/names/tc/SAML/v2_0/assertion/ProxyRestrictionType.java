...
public abstract class ProxyRestrictionType extends oasis.names.tc.SAML.v2_0.assertion.ConditionAbstractType 
implements java.io.Serializable
{
    ...
    public boolean equals(
        ...
        if (obj instanceof ProxyRestrictionType) {

            ProxyRestrictionType temp = (ProxyRestrictionType)obj;
            boolean thcycle;
            boolean tmcycle;
    ...
    public int hashCode(
        ...
        long tmp;
        result = 37 * result + (int)(_count^(_count>>>32));
