...
import oasis.names.tc.SAML.v2_0.assertion.AuthnContextTypeChoiceChoice;

/**
 * Class AuthnContextTypeChoiceChoiceDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class AuthnContextTypeChoiceChoiceDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public AuthnContextTypeChoiceChoiceDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                AuthnContextTypeChoiceChoice target = (AuthnContextTypeChoiceChoice) object;
        ...
        //-- validation code for: _authnContextDecl
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
        //-- _authnContextDeclRef
        ...
        //-- validation code for: _authnContextDeclRef
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass(
        ...
        return oasis.names.tc.SAML.v2_0.assertion.AuthnContextTypeChoiceChoice.class;
    }
