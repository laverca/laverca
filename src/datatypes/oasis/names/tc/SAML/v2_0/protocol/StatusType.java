...
public abstract class StatusType implements java.io.Serializable {
     ...
     * Field _statusDetail.
     */
    private oasis.names.tc.SAML.v2_0.protocol.StatusDetail _statusDetail;
     ...
     */
    public oasis.names.tc.SAML.v2_0.protocol.StatusDetail getStatusDetail(
    ) {
    ...
    public void setStatusDetail(
            final oasis.names.tc.SAML.v2_0.protocol.StatusDetail statusDetail) {
