...
public class MSS_NotificationBindingStub extends org.apache.axis.client.Stub
implements MSS_NotificationPortType
{
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("MSS_Notification");
        oper.addParameter(new QName("http://uri.etsi.org/TS102204/v1.1.2#", "MSS_StatusResp"),
                          new QName("http://uri.etsi.org/TS102204/v1.1.2#", "MSS_StatusRespType"),
                          org.etsi.uri.TS102204.v1_1_2.MSS_StatusResp.class,
                          ParameterDesc.IN, false, false);
        oper.setReturnType(new QName("http://uri.etsi.org/TS102204/v1.1.2#", "MSS_ReceiptReqType"));
        oper.setReturnClass(org.etsi.uri.TS102204.v1_1_2.MSS_ReceiptReqType.class);
        oper.setReturnQName(new QName("http://uri.etsi.org/TS102204/v1.1.2#", "MSS_ReceiptReq"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[0] = oper;
    }

    public MSS_NotificationBindingStub() throws org.apache.axis.AxisFault {
        this(null);
    }

    public MSS_NotificationBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        this(service);
        super.cachedEndpoint = endpointURL;
    }

    public MSS_NotificationBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public org.etsi.uri.TS102204.v1_1_2.MSS_ReceiptReqType MSS_Notification(org.etsi.uri.TS102204.v1_1_2.MSS_StatusRespType MSS_StatusResp) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new QName("", "MSS_Notification"));

        setRequestHeaders(_call);
        setAttachments(_call);
        Object _resp = _call.invoke(new Object[] {MSS_StatusResp});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (org.etsi.uri.TS102204.v1_1_2.MSS_ReceiptReqType) _resp;
            } catch (Exception _exception) {
                return (org.etsi.uri.TS102204.v1_1_2.MSS_ReceiptReqType) org.apache.axis.utils.JavaUtils.convert(_resp, org.etsi.uri.TS102204.v1_1_2.MSS_ReceiptReqType.class);
            }
        }
    }
}
