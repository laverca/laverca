...
public class MSS_ProfileQueryBindingStub extends org.apache.axis.client.Stub
implements MSS_ProfileQueryType
{
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(new QName("http://uri.etsi.org/TS102204/v1.1.2#", "MSS_ProfileReq"),
                          new QName("http://uri.etsi.org/TS102204/v1.1.2#", "MSS_ProfileReqType"),
                          org.etsi.uri.TS102204.v1_1_2.MSS_ProfileReq.class,
                          ParameterDesc.IN, false, false);
        oper.setReturnType(new QName("http://uri.etsi.org/TS102204/v1.1.2#", "MSS_ProfileRespType"));
        oper.setReturnClass(org.etsi.uri.TS102204.v1_1_2.MSS_ProfileRespType.class);
        oper.setReturnQName(new QName("http://uri.etsi.org/TS102204/v1.1.2#", "MSS_ProfileResp"));
    ...
    public MSS_ProfileQueryBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        qName = new QName("http://uri.etsi.org/TS102204/v1.1.2#", "MSS_ProfileReqType");
        cachedSerQNames.add(qName);
        cls = org.etsi.uri.TS102204.v1_1_2.MSS_ProfileReq.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);

        qName = new QName("http://uri.etsi.org/TS102204/v1.1.2#", "MSS_ProfileRespType");
        cachedSerQNames.add(qName);
        cls = org.etsi.uri.TS102204.v1_1_2.MSS_ProfileResp.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);	   
    }
    ...
    public org.etsi.uri.TS102204.v1_1_2.MSS_ProfileRespType MSS_ProfileQuery(org.etsi.uri.TS102204.v1_1_2.MSS_ProfileReqType MSS_ProfileReq) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new QName("", "MSS_ProfileQuery"));

        setRequestHeaders(_call);
        setAttachments(_call);
        Object _resp = _call.invoke(new Object[] {MSS_ProfileReq});
