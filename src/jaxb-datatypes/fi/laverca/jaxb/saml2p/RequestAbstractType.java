...
@XmlType(name = "RequestAbstractType", namespace = "urn:oasis:names:tc:SAML:2.0:protocol", propOrder = {
    "issuer",
    "signature",
    "extensions"
})
...
public abstract class RequestAbstractType implements Locatable
{
    ...
    @XmlElement(name = "Extensions", namespace = "urn:oasis:names:tc:SAML:2.0:protocol")
