...
import fi.laverca.jaxb.saml2a.Conditions;
...
@XmlType(name = "AuthnRequestType", namespace = "urn:oasis:names:tc:SAML:2.0:protocol", propOrder = {
    "subject",
    "nameIDPolicy",
    "conditions",
    ...
    extends RequestAbstractType
{
    ...
    @XmlElement(name = "NameIDPolicy", namespace = "urn:oasis:names:tc:SAML:2.0:protocol")
    ...
    @XmlElement(name = "Scoping", namespace = "urn:oasis:names:tc:SAML:2.0:protocol")
