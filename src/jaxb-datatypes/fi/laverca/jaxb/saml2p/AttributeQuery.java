...
@XmlType(name = "AttributeQueryType", namespace = "urn:oasis:names:tc:SAML:2.0:protocol", propOrder = {
    "attributes"
})
@XmlRootElement(name = "AttributeQuery", namespace = "urn:oasis:names:tc:SAML:2.0:protocol")
