...
@XmlType(name = "AdviceType", namespace = "urn:oasis:names:tc:SAML:2.0:assertion", propOrder = {
    "assertionIDRevesAndAssertionURIRevesAndAssertions"
})
@XmlRootElement(name = "Advice", namespace = "urn:oasis:names:tc:SAML:2.0:assertion")
public class Advice
