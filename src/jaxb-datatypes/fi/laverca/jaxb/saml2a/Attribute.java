...
public class Attribute implements Locatable
{

    @XmlElement(name = "AttributeValue", namespace = "urn:oasis:names:tc:SAML:2.0:assertion", type = Object.class, nillable = true)
