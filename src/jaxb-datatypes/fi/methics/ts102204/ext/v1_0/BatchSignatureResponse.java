...
@XmlRootElement(name = "BatchSignatureResponse", namespace = "http://www.methics.fi/TS102204/ext/v1.0.0#BatchSignature")
public class BatchSignatureResponse
    implements Locatable
{

    @XmlElement(name = "MSS_Signature", namespace = "http://www.methics.fi/TS102204/ext/v1.0.0#BatchSignature")
