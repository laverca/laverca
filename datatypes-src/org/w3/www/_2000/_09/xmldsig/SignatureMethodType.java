...
public abstract class SignatureMethodType implements java.io.Serializable {
     ...
     */
    private long _HMACOutputLength;

    /**
     * keeps track of state for field: _HMACOutputLength
     */
    private boolean _has_HMACOutputLength;
    ...
    /**
     */
    public void deleteHMACOutputLength(
    ) {
        this._has_HMACOutputLength= false;
    }
    ...
    public boolean equals(
        ...
        if (obj instanceof SignatureMethodType) {
            ...
            SignatureMethodType temp = (SignatureMethodType)obj;
            boolean thcycle;
            boolean tmcycle;
            ...
            if (this._content != null) {
                ...
                return false;
            if (this._HMACOutputLength != temp._HMACOutputLength)
                return false;
            if (this._has_HMACOutputLength != temp._has_HMACOutputLength)
                return false;
    ...
    /**
     * Returns the value of field 'HMACOutputLength'.
     * 
     * @return the value of field 'HMACOutputLength'.
     */
    public long getHMACOutputLength(
    ) {
        return this._HMACOutputLength;
    }

    /**
     * Method hasHMACOutputLength.
     * 
     * @return true if at least one HMACOutputLength has been added
     */
    public boolean hasHMACOutputLength(
    ) {
        return this._has_HMACOutputLength;
    }
    ...
    public int hashCode(
        ...
        result = 37 * result + (int)(_HMACOutputLength^(_HMACOutputLength>>>32));
        if (_anyObject != null
    ...
    /**
     * Sets the value of field 'HMACOutputLength'.
     * 
     * @param HMACOutputLength the value of field 'HMACOutputLength'
     */
    public void setHMACOutputLength(
            final long HMACOutputLength) {
        this._HMACOutputLength = HMACOutputLength;
        this._has_HMACOutputLength = true;
    }
