...
/**
 * Class AuthnContextTypeChoiceSequenceChoice.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class AuthnContextTypeChoiceSequenceChoice implements java.io.Serializable {
    ...
    public AuthnContextTypeChoiceSequenceChoice() {
        super();
    }
    ...
    public boolean equals(
        ...
        if (obj instanceof AuthnContextTypeChoiceSequenceChoice) {

            AuthnContextTypeChoiceSequenceChoice temp = (AuthnContextTypeChoiceSequenceChoice)obj;
            boolean thcycle;
            boolean tmcycle;
     ...
     * oasis.names.tc.SAML.v2_0.assertion.AuthnContextTypeChoiceSequenceChoice
     */
    public static oasis.names.tc.SAML.v2_0.assertion.AuthnContextTypeChoiceSequenceChoice unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (oasis.names.tc.SAML.v2_0.assertion.AuthnContextTypeChoiceSequenceChoice) org.exolab.castor.xml.Unmarshaller.unmarshal(oasis.names.tc.SAML.v2_0.assertion.AuthnContextTypeChoiceSequenceChoice.class, reader);
    }
