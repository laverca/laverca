...
import oasis.names.tc.SAML.v2_0.protocol.AuthnQueryType;

/**
 * Class AuthnQueryTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class AuthnQueryTypeDescriptor extends oasis.names.tc.SAML.v2_0.protocol.descriptors.SubjectQueryAbstractTypeDescriptor {
    ...
    public AuthnQueryTypeDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                AuthnQueryType target = (AuthnQueryType) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return oasis.names.tc.SAML.v2_0.protocol.AuthnQueryType.class;
    }
