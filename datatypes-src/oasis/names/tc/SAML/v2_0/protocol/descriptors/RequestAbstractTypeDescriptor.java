...
/**
 * Class RequestAbstractTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class RequestAbstractTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RequestAbstractTypeDescriptor() {
        super();
        _nsURI = "urn:oasis:names:tc:SAML:2.0:protocol";
        _xmlName = "RequestAbstractType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                RequestAbstractType target = (RequestAbstractType) object;
                return target.getID();
            }
            @Override
    ...
    public java.lang.Class getJavaClass(
        ...
        return oasis.names.tc.SAML.v2_0.protocol.RequestAbstractType.class;
    }
